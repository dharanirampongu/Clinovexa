...
const Home = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-100 font-sans selection:bg-teal-500 selection:text-white dark:selection:text-slate-950 relative overflow-hidden transition-colors">
      ...
      <header className="sticky top-0 z-50 backdrop-blur-md bg-white/80 dark:bg-slate-950/80 border-b border-slate-200 dark:border-slate-800/80 transition-colors">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
          <div className="flex items-center space-x-3 cursor-pointer" onClick={() => navigate('/')}>
            ...
            <div>
              <span className="text-xl font-bold tracking-tight bg-gradient-to-r from-slate-900 via-slate-700 dark:from-white dark:via-slate-200 to-teal-500 dark:to-teal-400 bg-clip-text text-transparent">
                Clinovexa
              </span>
              <span className="text-[10px] block font-mono text-teal-700 dark:text-teal-400/80 tracking-widest uppercase font-semibold">
                Healthcare OS
              </span>
            </div>
          </div>
          ...
          <div className="flex items-center space-x-4">
            <button
              onClick={toggleTheme}
              className="p-2 rounded-lg bg-slate-100 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-slate-200 transition-colors"
              title="Toggle Theme"
            >
      ...
      <section className="relative pt-16 pb-20 md:pt-24 md:pb-32 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto text-center">
        <div className="inline-flex items-center space-x-2 px-3.5 py-1.5 rounded-full bg-teal-500/10 border border-teal-500/30 text-teal-700 dark:text-teal-300 text-xs font-medium mb-8 backdrop-blur-sm animate-pulse">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 max-w-md mx-auto mb-16">
          ...
          <a
            href="#portals"
            className="w-full sm:w-auto px-8 py-4 rounded-xl bg-white dark:bg-slate-900 hover:bg-slate-100 dark:hover:bg-slate-800 border border-slate-200 dark:border-slate-800 text-slate-700 dark:text-slate-200 font-semibold text-base transition-all flex items-center justify-center space-x-2"
          >
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-4xl mx-auto text-left">
          <div className="p-5 rounded-2xl bg-white dark:bg-slate-900/60 border border-slate-200 dark:border-slate-800/80 backdrop-blur-sm transition-colors">
            <div className="text-3xl font-bold text-slate-900 dark:text-white mb-1">5 Portals</div>
            <div className="text-xs text-slate-500 dark:text-slate-400 font-medium">Role-Based Access Control</div>
          </div>
          <div className="p-5 rounded-2xl bg-white dark:bg-slate-900/60 border border-slate-200 dark:border-slate-800/80 backdrop-blur-sm transition-colors">
            <div className="text-3xl font-bold text-teal-600 dark:text-teal-400 mb-1">100%</div>
            <div className="text-xs text-slate-500 dark:text-slate-400 font-medium">Staff ID Verification Security</div>
          </div>
          <div className="p-5 rounded-2xl bg-white dark:bg-slate-900/60 border border-slate-200 dark:border-slate-800/80 backdrop-blur-sm transition-colors">
            <div className="text-3xl font-bold text-cyan-600 dark:text-cyan-400 mb-1">PDF Direct</div>
            <div className="text-xs text-slate-500 dark:text-slate-400 font-medium">Lab Upload & Auto Notifications</div>
          </div>
          <div className="p-5 rounded-2xl bg-white dark:bg-slate-900/60 border border-slate-200 dark:border-slate-800/80 backdrop-blur-sm transition-colors">
            <div className="text-3xl font-bold text-purple-600 dark:text-purple-400 mb-1">24/7 AI</div>
            <div className="text-xs text-slate-500 dark:text-slate-400 font-medium">Prescription Safety Assistant</div>
          </div>
        </div>
      </section>

      {/* Portals Showcase Section */}
      <section id="portals" className="py-20 bg-slate-100 dark:bg-slate-900/40 border-y border-slate-200 dark:border-slate-800/60 relative transition-colors">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <button
                  ...
                  className={`flex items-center space-x-2.5 px-5 py-3 rounded-xl font-medium text-sm transition-all ${
                    isActive
                      ...
                      : 'bg-white dark:bg-slate-900 hover:bg-slate-100 dark:hover:bg-slate-850 text-slate-500 dark:text-slate-400 hover:text-slate-900 dark:hover:text-slate-200 border border-slate-200 dark:border-slate-800'
                  }`}
                >
          ...
          {portals.filter(p => p.id === activePortalTab).map((portal) => {
            const Icon = portal.icon;
            return (
              <div key={portal.id} className="p-8 sm:p-10 rounded-3xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-2xl relative overflow-hidden transition-colors">
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      <div className="flex items-center space-x-3 mb-1">
                        <h3 className="text-2xl font-bold text-slate-900 dark:text-white">{portal.title}</h3>
                        <span className={`px-2.5 py-0.5 rounded-full text-xs font-bold border uppercase tracking-wider ${portal.badgeColor}`}>
                          {portal.role}
                        </span>
                      </div>
                      <p className="text-slate-600 dark:text-slate-400 text-sm">{portal.description}</p>
                    </div>
                  </div>
                  <button
                    onClick={() => navigate('/login')}
                    className="self-start md:self-auto px-5 py-2.5 rounded-xl bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-750 text-teal-700 dark:text-teal-400 font-semibold text-sm border border-slate-200 dark:border-slate-700/80 flex items-center space-x-2 transition-all"
                  >
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  {portal.features.map((feat, idx) => (
                    <div key={idx} className="flex items-start space-x-3 p-4 rounded-xl bg-slate-50 dark:bg-slate-950/60 border border-slate-200 dark:border-slate-800/80 transition-colors">
                      <CheckCircle2 className="w-5 h-5 text-teal-600 dark:text-teal-400 shrink-0 mt-0.5" />
                      <span className="text-slate-700 dark:text-slate-300 text-sm leading-relaxed">{feat}</span>
                    </div>
                  ))}
                </div>
              </div>
      ...
      <section id="ai-assistant" className="py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div>
            <div className="inline-flex items-center space-x-2 px-3 py-1 rounded-full bg-purple-500/10 border border-purple-500/30 text-purple-700 dark:text-purple-300 text-xs font-medium mb-6">
            ...
            <h2 className="text-3xl sm:text-4xl font-bold text-slate-900 dark:text-white mb-6 leading-tight">
              ...
              <span className="text-purple-600 dark:text-purple-400">Clear Explanations for Patients</span>
            </h2>
            ...
            <div className="space-y-4">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h4 className="text-slate-900 dark:text-white font-semibold text-base">Instant Preset Queries</h4>
                  <p className="text-slate-600 dark:text-slate-400 text-sm">One-click answers for "What is this medicine for?", "How to take?", and "Dosage breakdown".</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h4 className="text-slate-900 dark:text-white font-semibold text-base">Educational Guardrails</h4>
                  <p className="text-slate-600 dark:text-slate-400 text-sm">Enforces strict medical disclaimer headers advising consultation with prescribing doctors.</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="p-6 rounded-3xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-2xl relative transition-colors">
            <div className="flex items-center justify-between pb-4 border-b border-slate-200 dark:border-slate-800 mb-4">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h5 className="text-sm font-bold text-slate-900 dark:text-white">AI Prescription Assistant</h5>
                  <span className="text-[11px] text-purple-600 dark:text-purple-400 font-mono">Prescription #RX-8849</span>
                </div>
              </div>
              <span className="px-2 py-0.5 rounded bg-emerald-500/10 border border-emerald-500/20 text-emerald-600 dark:text-emerald-400 text-[10px] font-bold uppercase">
                Active AI Guardrail
              </span>
            </div>
            ...
            <div className="space-y-3 mb-4 text-xs">
              <div className="p-3 rounded-xl bg-slate-100 dark:bg-slate-800/80 text-slate-700 dark:text-slate-200 border border-slate-200 dark:border-slate-700/60 max-w-[85%] self-end ml-auto">
                💬 <strong>Patient:</strong> "How should I take Amoxicillin 500mg?"
              </div>

              <div className="p-3.5 rounded-xl bg-purple-50 dark:bg-purple-950/40 text-slate-700 dark:text-slate-200 border border-purple-200 dark:border-purple-500/30 max-w-[95%]">
                <div className="font-bold text-purple-700 dark:text-purple-300 mb-1">🤖 AI Explanation:</div>
                ...
                <div className="p-2 rounded bg-amber-500/10 border border-amber-500/20 text-amber-800 dark:text-amber-300 text-[11px]">
            ...
            <div className="flex gap-2">
              <input
                ...
                className="w-full bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 text-slate-500 dark:text-slate-400 text-xs rounded-lg px-3 py-2"
              />
      ...
      <section id="security" className="py-20 bg-slate-100 dark:bg-slate-900/40 border-t border-slate-200 dark:border-slate-800/60 transition-colors">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-14">
            <div className="inline-flex items-center space-x-2 px-3 py-1 rounded-full bg-teal-500/10 border border-teal-500/30 text-teal-700 dark:text-teal-300 text-xs font-medium mb-4">
          ...
          <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
            <div className="p-6 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 transition-colors">
              ...
              <h3 className="text-lg font-bold text-slate-900 dark:text-white mb-2">Staff ID Verification</h3>
            ...
            <div className="p-6 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 transition-colors">
              ...
              <h3 className="text-lg font-bold text-slate-900 dark:text-white mb-2">JWT & Role Verification</h3>
              <p className="text-slate-600 dark:text-slate-400 text-sm leading-relaxed">
            ...
            <div className="p-6 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 transition-colors">
              ...
              <h3 className="text-lg font-bold text-slate-900 dark:text-white mb-2">Secure PDF Streaming</h3>
              <p className="text-slate-600 dark:text-slate-400 text-sm leading-relaxed">
      ...
      <section id="demo" className="py-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="p-8 sm:p-12 rounded-3xl bg-gradient-to-b from-white dark:from-slate-900 to-slate-100 dark:to-slate-950 border border-slate-200 dark:border-slate-800 shadow-2xl text-center transition-colors">
          <h2 className="text-3xl font-bold text-slate-900 dark:text-white mb-3">Instant Demo Credentials</h2>
          <p className="text-slate-600 dark:text-slate-400 text-sm sm:text-base max-w-xl mx-auto mb-8">
            You can log into any portal using the pre-seeded credentials below (Password: <code className="text-teal-700 dark:text-teal-400 font-mono font-bold bg-slate-100 dark:bg-slate-900 px-2 py-0.5 rounded border border-slate-200 dark:border-slate-800">Password123!</code>).
          </p>

          <div className="grid sm:grid-cols-2 lg:grid-cols-5 gap-4 max-w-5xl mx-auto mb-8">
            {demoAccounts.map((acc, idx) => (
              <div key={idx} className={`p-4 rounded-xl bg-slate-50 dark:bg-slate-950/80 border ${acc.color} text-left transition-colors`}>
                <div className="text-xs font-bold text-teal-700 dark:text-teal-400 uppercase tracking-wider mb-1">{acc.role}</div>
                <div className="text-xs font-mono text-slate-700 dark:text-slate-200 truncate mb-1" title={acc.email}>{acc.email}</div>
      ...
      {/* Footer */}
      <footer className="border-t border-slate-200 dark:border-slate-800/80 py-10 bg-white dark:bg-slate-950 text-slate-500 text-xs transition-colors">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="flex items-center space-x-3">
            <div className="w-7 h-7 rounded-lg bg-teal-500/20 flex items-center justify-center">
              <Activity className="w-4 h-4 text-teal-600 dark:text-teal-400" />
            </div>
            <span className="font-semibold text-slate-700 dark:text-slate-300">Clinovexa Healthcare Platform</span>
          </div>

          <div className="flex items-center space-x-2 text-emerald-600 dark:text-emerald-400 font-mono">
